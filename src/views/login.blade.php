...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ VOYAGER_ASSETS_PATH }}/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page animated zoomIn">
    <div class="login-box">
      <img src="{{ VOYAGER_ASSETS_PATH }}/images/logo-icon.png">
    ...
    <!-- iCheck -->
    <script src="{{ VOYAGER_ASSETS_PATH }}/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
